...
<body>
    <div>
        <center>
            <hr class='mb-3'>
            <h1 class="white">Promijenite zalihu</h3>
            <h5 class="white"><br>ID proizvoda = <?= $id ?><br>Naziv proizvoda = <?= $naziv ?><br>Trenutno stanje proizvoda = <?= $zaliha ?></h5>
            <br>
            <form method="post">
                <label class="white" for="kol">Količina za dodati/oduzeti: </label>
                <input type="number" id="kol" name="kol" style="width: 10%;" value="0"><br><br>
                <br>
                <hr class='mb-3'>
                <div><br>
                    <div class='tipke_div'>
                        <div class='tipke_s_div'>
                            <button class='btn_kosarica' stype="submit" name="dodaj">Primjeni</button>
                        </div>
                        <div class='tipke_s_div'>
    ...
    <?php
        if(isset($_POST['dodaj'])){
            ...
            $sql = "UPDATE products SET zaliha='$uk_zal' WHERE id='$id'";
